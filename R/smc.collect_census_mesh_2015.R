#' @title to read files
#' @description \code{smc.collect_census_mesh_5_2015}


smc.collect_census_mesh_2015 <- function(pref_code){
  # pref_codeの調整
  library(utils)
  if (pref_code <= 9){
  ...
  # ========== 変数1 ダウンロード ========== #
  # ディレクトリを作成
  download_dir_1 <- paste(as.character(pref_code), "国勢調査メッシュ2015_1", sep = "")
  ...
  # ========== 変数2 ダウンロード ========== #
  # ディレクトリを作成
  download_dir_2 <- paste(as.character(pref_code), "国勢調査メッシュ2015_2", sep = "")
  ...
  # ========== 変数3 ダウンロード ========== #
  # ディレクトリを作成
  download_dir_3 <- paste(as.character(pref_code), "国勢調査メッシュ2015_3", sep = "")
