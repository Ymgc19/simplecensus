...
smc.convert_percentage_vars_2015 <- function(sf_df){
  sf_df <- sf_df %>%
    mutate(
      ...
      smc.per.households_communal6_11 = smc.households_communal6_11 / smc.households,
      smc.per.households_communal12_ = smc.households_communal12_ / smc.households,
      # 産業別人数
      smc.per.industry_A = smc.industry_A / smc.population,
      smc.per.industry_B = smc.industry_B / smc.population,
      smc.per.industry_C = smc.industry_C / smc.population,
      smc.per.industry_D = smc.industry_D / smc.population,
      smc.per.industry_E = smc.industry_E / smc.population,
      smc.per.industry_F = smc.industry_F / smc.population,
      smc.per.industry_G = smc.industry_G / smc.population,
      smc.per.industry_H = smc.industry_H / smc.population,
      smc.per.industry_I = smc.industry_I / smc.population,
      smc.per.industry_J = smc.industry_J / smc.population,
      smc.per.industry_K = smc.industry_K / smc.population,
      smc.per.industry_L = smc.industry_L / smc.population,
      smc.per.industry_M = smc.industry_M / smc.population,
      smc.per.industry_N = smc.industry_N / smc.population,
      smc.per.industry_O = smc.industry_O / smc.population,
      smc.per.industry_P = smc.industry_P / smc.population,
      smc.per.industry_Q = smc.industry_Q / smc.population,
      smc.per.industry_R = smc.industry_R / smc.population,
      smc.per.industry_S = smc.industry_S / smc.population,
      smc.per.industry_T = smc.industry_T / smc.population,
      smc.per.employer = smc.employer / smc.population,
      smc.per.self_employed = smc.self_employed / smc.population,
      smc.per.family_worker = smc.family_worker / smc.population,
      # 職業別就業者数
      smc.per.sector_A = smc.sector_A / smc.population,
      smc.per.sector_B = smc.sector_B / smc.population,
      smc.per.sector_C = smc.sector_C / smc.population,
      smc.per.sector_D = smc.sector_D / smc.population,
      smc.per.sector_E = smc.sector_E / smc.population,
      smc.per.sector_F = smc.sector_F / smc.population,
      smc.per.sector_G = smc.sector_G / smc.population,
      smc.per.sector_H = smc.sector_H / smc.population,
      smc.per.sector_I = smc.sector_I / smc.population,
      smc.per.sector_J = smc.sector_J / smc.population,
      smc.per.sector_K = smc.sector_K / smc.population,
      smc.per.sector_L = smc.sector_L / smc.population,
      # 経済構成別世帯割合
