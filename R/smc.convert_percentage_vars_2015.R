...
smc.convert_percentage_vars_2015 <- function(sf_df){
  sf_df <- sf_df %>%
    mutate(
      ...
      # 産業別人数
      smc.per.industry_A = smc.industry_A / smc.worker_15,
      smc.per.industry_B = smc.industry_B / smc.worker_15,
      smc.per.industry_C = smc.industry_C / smc.worker_15,
      smc.per.industry_D = smc.industry_D / smc.worker_15,
      smc.per.industry_E = smc.industry_E / smc.worker_15,
      smc.per.industry_F = smc.industry_F / smc.worker_15,
      smc.per.industry_G = smc.industry_G / smc.worker_15,
      smc.per.industry_H = smc.industry_H / smc.worker_15,
      smc.per.industry_I = smc.industry_I / smc.worker_15,
      smc.per.industry_J = smc.industry_J / smc.worker_15,
      smc.per.industry_K = smc.industry_K / smc.worker_15,
      smc.per.industry_L = smc.industry_L / smc.worker_15,
      smc.per.industry_M = smc.industry_M / smc.worker_15,
      smc.per.industry_N = smc.industry_N / smc.worker_15,
      smc.per.industry_O = smc.industry_O / smc.worker_15,
      smc.per.industry_P = smc.industry_P / smc.worker_15,
      smc.per.industry_Q = smc.industry_Q / smc.worker_15,
      smc.per.industry_R = smc.industry_R / smc.worker_15,
      smc.per.industry_S = smc.industry_S / smc.worker_15,
      smc.per.industry_T = smc.industry_T / smc.worker_15,
      smc.per.employer = smc.employer / smc.worker_15,
      smc.per.self_employed = smc.self_employed / smc.worker_15,
      smc.per.family_worker = smc.family_worker / smc.worker_15,
      # 職業別就業者数
