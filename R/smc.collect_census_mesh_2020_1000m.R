...
smc.collect_census_mesh_2020_1000m <- function(pref_code){
  # pref_codeの調整
  library(utils)
  if (pref_code <= 9){
  ...
  # urlを調整
  # 250m　その1
  url1_1 <- "https://www.e-stat.go.jp/gis/statmap-search/data?statsId=T001100&code="
  url1_2 <- "&downloadType=2"
  # 250m その2
  url2_1 <- "https://www.e-stat.go.jp/gis/statmap-search/data?statsId=T001107&code="
  url2_2 <- "&downloadType=2"
  # 250m　その3
  url3_1 <- "https://www.e-stat.go.jp/gis/statmap-search/data?statsId=T001140&code="
  url3_2 <- "&downloadType=2"
  # 250m　その4
  url4_1 <- "https://www.e-stat.go.jp/gis/statmap-search/data?statsId=T001143&code="
